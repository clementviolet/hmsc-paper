...
pandoc manuscript.md -s -o rendered/$repo.docx --filter pandoc-xnos --bibliography=./rendered/references.json --csl=.assets/templates/ecology-letters.cls --metadata-file=metadata.json
